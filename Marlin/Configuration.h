...
#define STRING_CONFIG_H_AUTHOR "(Thadd1us, Ender-3)" // Who made the changes. //Customized DBP
...
#define CUSTOM_MACHINE_NAME "Ender 3 Pro" //Customized TRS
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  32.51  //Customized TRS
    #define DEFAULT_Ki   3.13  //Customized TRS 
    #define DEFAULT_Kd  84.52  //Customized TRS
  #endif
#else
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 189.11  //Customized TRS
  #define DEFAULT_bedKi 36.94   //Customized TRS
  #define DEFAULT_bedKd 645.49  //Customized TRS
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU         // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash) //Customized TRS
  #define PID_AUTOTUNE_MENU     // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) //Customized TRS
#endif
...
#define EXTRUDE_MAXLENGTH 500 //Customized TRS
...
#define DEFAULT_TRAVEL_ACCELERATION    1000   // X, Y, Z acceleration for travel (non printing) moves //Customized TRS
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -48, -10.5, 0 }
 ...
 */
#define MULTIPLE_PROBING 2 //Customized TRS
#define EXTRA_PROBING    1 //Customized TRS
...
#define X_MIN_POS -3.6
#define Y_MIN_POS -13.6
#define Z_MIN_POS 0
...
#define MIN_SOFTWARE_ENDSTOPS
  ...
  //#define MIN_SOFTWARE_ENDSTOP_Z //Customized TRS
...
#define AUTO_BED_LEVELING_BILINEAR //Customized TRS
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //Customized TRS
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION //Customized TRS
  ...
  //#define PROBE_Y_FIRST
    ...
    //
    #define ABL_BILINEAR_SUBDIVISION //Customized TRS
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.04 // (mm) Step size while manually probing Z axis. //Customized TRS
 ...
 */
#define Z_SAFE_HOMING //Customized TRS
...
#define PREHEAT_1_TEMP_HOTEND 215 //Customized TRS
#define PREHEAT_1_TEMP_BED     60 //Customized TRS
#define PREHEAT_1_TEMP_CHAMBER 35
#define PREHEAT_1_FAN_SPEED   255 // Value from 0 to 255

#define PREHEAT_2_LABEL       "ABS/PETG" //Customized TRS
#define PREHEAT_2_TEMP_HOTEND 240
#define PREHEAT_2_TEMP_BED    80 //Customized TRS
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 } //Customized TRS
